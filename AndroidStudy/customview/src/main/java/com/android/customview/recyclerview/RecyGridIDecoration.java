...
/**
 * @author dupengcan@xiaoxiangyoupin.cn
 * @version v1.0.0
 */
public class RecyGridIDecoration extends RecyclerView.ItemDecoration {
    ...
    private RecyGridIDecoration(int horizonSpan, int verticalSpan, int color, boolean showLastLine) {
...
//            //满足条件( 最后一行 && 不绘制 ) 将vertical多出的一部分去掉;
    ...
    public static class Builder {
        ...
        public RecyGridIDecoration build() {
            return new RecyGridIDecoration(mHorizonSpan, mVerticalSpan, mColor,mShowLastLine);
        }
    }
}
